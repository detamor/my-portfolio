...
import { X, Database, Workflow, Shield, Layout, Server, Cpu, Users, Zap, Key, Activity, Code2, Share2 } from "lucide-react";
  ...
  <>
    ...
    <section className="grid lg:grid-cols-2 gap-16 items-start">
      ...
      <div className="lg:order-1 bg-zinc-900/50 border border-white/5 rounded-3xl aspect-square md:aspect-video flex items-center justify-center relative group overflow-hidden">
         ...
         <span className="absolute text-[10px] font-mono text-zinc-500 uppercase tracking-widest text-center px-8">RBAC Permission Matrix (Enterprise Secured)</span>
      </div>
    </section>
  ...
  <>
    ...
    <section className="grid lg:grid-cols-2 gap-16 items-start">
      ...
      <div className="bg-zinc-900/50 border border-white/5 rounded-3xl p-12 aspect-video flex flex-col items-center justify-center relative overflow-hidden group">
         ...
         <span className="mt-8 text-[10px] font-mono text-zinc-500 uppercase tracking-widest">Interservice RESTful API Sync</span>
      </div>
    </section>
...
const CaseStudyModal = ({ isOpen, onClose, project }) => {
  ...
  const isAIProject = project.id === 2;
        ...
        <>
          ...
          >
            ...
            <div className="flex items-center justify-between p-8 md:p-12 border-b border-white/5 bg-white/[0.01]">
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <div className={`px-2 py-0.5 rounded-full border ${isAIProject ? 'border-blue-500/30 bg-blue-500/5 text-blue-300' : 'border-indigo-500/30 bg-indigo-500/5 text-indigo-300'} text-[8px] font-mono uppercase tracking-widest`}>
                    {isAIProject ? 'Research Validated' : 'Enterprise Secured'}
                  </div>
                </div>
            ...
            <div className="flex-1 overflow-y-auto p-8 md:p-12 space-y-24 custom-scrollbar">
              {isAIProject ? <AICaseStudy /> : <EnterpriseCaseStudy />}
            </div>
            ...
            <div className="p-8 md:p-12 border-t border-white/5 bg-white/[0.01] flex flex-col md:flex-row items-center justify-between gap-6">
               <div className="flex items-center gap-4">
                  <div className={`w-2 h-2 rounded-full ${isAIProject ? 'bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.6)]' : 'bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.6)]'} animate-pulse`}></div>
                  <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest italic">
                    {isAIProject ? 'Academic Validity Confirmed // 2026' : 'System Integrity Verified // 2026'}
                  </span>
               </div>
               <div className="px-6 py-3 rounded-full border border-white/5 bg-white/5 text-[10px] font-mono text-zinc-300 uppercase tracking-widest">
                  {isAIProject ? 'Decoupled AI Architecture' : 'Enterprise Grade Architecture'}
               </div>
            </div>
          </motion.div>
        </>
